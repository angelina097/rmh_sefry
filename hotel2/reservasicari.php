...
$reservasicari = mysql_query($query_reservasicari, $hotel2) or die(mysql_error());
...
<table border="1">
   ...
   <?php do { ?>
     <tr>
       <td><?php echo $row_reservasicari['id_reservasi']; ?></td>
       <td><?php echo $row_reservasicari['nmr_kamar']; ?></td>
       <td><?php echo $row_reservasicari['id_tamu']; ?></td>
       <td><?php echo $row_reservasicari['tipe_kamar']; ?></td>
       <td><?php echo $row_reservasicari['nama_tamu']; ?></td>
     </tr>
     <?php } while ($row_reservasicari = mysql_fetch_assoc($reservasicari)); ?>
</table>
<p>&nbsp;</p>
 <p>&nbsp;</p>
<p>&nbsp;</p>
